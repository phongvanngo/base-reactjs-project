            ...
            <div id="admin-dashboard-container" className="show-sidebar">
                <aside id="admin-sidebar" className="overflow-hidden fixed pb-7 px-0 bg-black ">
                    <div className="overflow-hidden px-0 space-y-2 h-full flex flex-col justify-between">
                        <div className="menu-list">
                            ...
                            <ul className="mt-5 flex flex-col space-y-5 list-none">
                                <li className="px-4 sidebar__link ">
                                    <Link className="h-8 flex items-center cursor-pointer" to={MOVIE_MANAGEMENT}>
                                        <svg
                                            width="18"
                                            height="18"
                                            strokeWidth="2"
                                ...
                                <li className="px-4 sidebar__link" >
                                    <Link className="h-8 flex items-center cursor-pointer" to={THEATER_MANAGEMENT}>
                                ...
                                <li className="px-4 sidebar__link" >
                                    <Link className="h-8 flex items-center cursor-pointer" to={SHOWTIME_MANAGEMENT}>
                                        <svg
                                            width="18"
                                            height="18"
                                            strokeWidth="2"
                        ...
                        <button onClick={() => { handleLogout() }} className="menu-list sidebar__link px-4 h-8 flex items-center cursor-pointer focus:outline-none">
                            <svg
                                width="18"
                                height="18"
                                strokeWidth="2"
